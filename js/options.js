...
var stefanvdurl = "https://addons.opera.com/en/extensions/details/turn-off-the-lights";var stefanvdaacodeurl = encodeURIComponent(stefanvdurl);
...
// Download Upgrade
$("fndownload").addEventListener('click', function() {window.open("https://addons.opera.com/en/extensions/details/finance-toolbar");});
$("ppdownload").addEventListener('click', function() {window.open("https://addons.opera.com/en/extensions/details/proper-menubar");});
$("zodownload").addEventListener('click', function() {window.open("https://addons.opera.com/en/extensions/details/zoom");});
$("aadownload").addEventListener('click', function() {window.open("https://addons.opera.com/en/extensions/details/ambient-aurea");});

$("themedownload").addEventListener('click', function() {window.open("https://addons.opera.com/en/themes/details/turn-off-the-lights-theme");});
...
// Review box
$("war").addEventListener('click', function() {window.open("https://addons.opera.com/en/extensions/details/turn-off-the-lights", "_blank");$("sectionreviewbox").style.display = "none";chrome.storage.local.set({"reviewedlastonversion": chrome.runtime.getManifest().version});});
